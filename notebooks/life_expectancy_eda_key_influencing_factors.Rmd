...
This project aims to investigate the factors affecting life expectancy in various countries, including developed and developing nations. The study will analyze global disparities in life expectancy by assessing health risk factors, mortality indicators, vaccination and disease control measures, healthcare spending and resources, as well as socio-economic and educational aspects. By exploring the correlations between these variables and life expectancy, the analysis seeks to identify the main factors that impact life expectancy.
...
The analysis highlights that life expectancy is influenced by a complex set of factors, with notable differences between developed and developing countries.

Countries with lower life expectancy tend to face significant challenges, including higher adult and child mortality rates, as well as a higher prevalence of diseases such as HIV/AIDS. These factors, alongside thinness in younger age groups, exhibit strong negative correlations with life expectancy.

Conversely, vaccination coverage for diseases such as Hepatitis B, Polio, and DTP3 plays a crucial role, as higher vaccination rates are associated with improved health outcomes. This underscores the importance of public health measures in preventing infectious diseases, which significantly affect life expectancy.

Population size shows almost no correlation with life expectancy, indicating that the number of people in a country does not directly affect the longevity of its citizens.

Healthcare expenditure—both as a percentage of total expenditure and as a percentage of GDP—shows a positive correlation with life expectancy, underscoring the necessity of continuous investment in healthcare systems. Socio-economic factors like the HDI and years of schooling show even stronger relationships with life expectancy, suggesting that broader development, beyond just economic growth, is crucial. While GDP also shows a positive relationship, it is less impactful than education and human development.

In summary, increasing life expectancy is not a one-dimensional task. It requires a comprehensive approach that includes reducing mortality rates, enhancing vaccination coverage, and investing in both healthcare and socio-economic development.
